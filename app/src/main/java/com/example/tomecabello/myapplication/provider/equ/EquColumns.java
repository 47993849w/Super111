...
/**
 * Columns for the {@code equ} table.
 */
public class EquColumns implements BaseColumns {
    public static final String TABLE_NAME = "equ";
    ...
    public static boolean hasColumns(String[] projection) {
        ...
        for (String c : projection) {
            ...
            if (c.equals(ESTADO) || c.contains("." + ESTADO)) return true;
